...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/tFIrPffY-/model.json', modelLoaded);
...
function gotResult(error, results){
    ...
    if (results[0].label == "Com Máscara") {
        document.getElementById("update_emoji").innerHTML = "&#x1F637;"
    }
    if (results[0].label == "Sem Máscara") {
        document.getElementById("update_emoji").innerHTML = "&#x26d4;" 
    }
}
}